...
#define HATCH_Pin GPIO_PIN_9
#define HATCH_GPIO_Port GPIOE
#define SHOOT_JOGGING_Pin GPIO_PIN_11
#define SHOOT_JOGGING_GPIO_Port GPIOE
#define SHOOT_JOGGING_EXTI_IRQn EXTI15_10_IRQn
